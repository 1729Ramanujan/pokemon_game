...
const keys = Object.keys(grasspokemontable);
const index = Math.floor(Math.random() * keys.length);
const wildpokemon_id = keys[index]
var opp_level = Math.floor(Math.random() * (21)) + 30;
var opp_party = [duplicate(grasspokemontable[wildpokemon_id], opp_level, HPstatusCalculation(grasspokemontable[wildpokemon_id].maxhp, opp_level))];
