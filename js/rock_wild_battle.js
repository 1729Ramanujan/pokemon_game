...
const keys = Object.keys(rockpokemontable);
const index = Math.floor(Math.random() * keys.length);
const wildpokemon_id = keys[index]
var opp_level = Math.floor(Math.random() * (21)) + 30;
var opp_party = [duplicate(rockpokemontable[wildpokemon_id], opp_level, HPstatusCalculation(rockpokemontable[wildpokemon_id].maxhp, opp_level))];
